...
في هذا النشاط المعملي، ستستكشف قدرات Microsoft Cloud App Security.  وستستكشف المعلومات المتاحة على لوحة معلومات Cloud Discovery بالإضافة إلى القدرات المتاحة للتحقيق في النتائج والتحكم في التأثير على مؤسستك من خلال النهُج.  ملاحظة:  يجب أن يكون لدى المؤسسة ترخيص لاستخدام Microsoft Cloud App Security، وهي خدمة اشتراك قائمة على المستخدم. 
...
#### المهمة 3: في هذه المهمة، ستستكشف صفحات النهُج والتنبيهات في أمان تطبيق Microsoft Cloud.
...
#### المراجعة
في هذا النشاط المعملي، استكشفت قدرات Microsoft Cloud App Security.  واستعرضت المعلومات المتاحة على لوحة معلومات Cloud Discovery بالإضافة إلى القدرات المتاحة للتحقيق في النتائج والتحكم في التأثير على مؤسستك من خلال النهُج.