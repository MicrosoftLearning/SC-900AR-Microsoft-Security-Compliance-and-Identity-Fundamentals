...
1. من جزء التنقل الأيسر لمركز Microsoft 365 Compliance، حدد **الأذونات**.

1. من صفحة الأذونات والأدوار، ضمن مركز التوافق، حدد **الأدوار**.

1. في حقل البحث، أدخل **المخاطر الداخلية** ثم حدد أيقونة البحث (العدسة المكبرة).  لاحظ الأدوار العديدة التي تظهر.  كل من هذه الأدوار لها مستويات وصول مختلفة.  حدد **إدارة المخاطر الداخلية**.
...
1. من لوحة التنقل اليسرى، حدد الصفحة **الرئيسية** للعودة إلى مركز التوافق في صفحة مركز التوافق في Microsoft 365.
...
1. حدد علامة تبويب المستعرض المسماة، ** الرئيسية-التوافق في Microsoft 365**.  إذا كنت قد أغلقت علامة تبويب المستعرض هذه مسبقًا، فافتح Microsoft Edge وفي شريط العناوين، أدخل **compliance.microsoft.com**، وقم بتسجيل الدخول باستخدام بيانات اعتماد المسؤول.
...
1. قبل البدء في إعداد النهج، هناك بعض الإعدادات التي يجب تكوينها.  من صفحة إدارة المخاطر الداخلية، حدد **أيقونة الإعداد** في الزاوية العلوية اليسرى من الصفحة للوصول إلى إعدادات "المخاطر الداخلية".  
    1. تحقق من أنك في علامة التبويب **الخصوصية**:  بالنسبة للمستخدمين الذين يقومون بأنشطة تطابق نهج المخاطر الداخلية خاصتك، سيحدد هذا الإعداد ما إذا كان سيتم إظهار أسمائهم الفعلية أو استخدام إصدارات مجهولة الهوية لإخفاء هوياتهم.  حدد **عدم إظهار النسخ مجهولة المصدر لأسماء المستخدمين**، ثم حدد **حفظ**.
    
    1. حدد علامة التبويب **مؤشرات النهج**. بمجرد حدوث حدث مشغّل للنهج، يتم استخدام الأنشطة التي ترتبط بالمؤشرات المختارة في تحديد درجة المخاطرة للمستخدم. يتم تضمين مؤشرات النهج المحددة هنا في نماذج نهج المخاطر الداخلية.  قم بالتمرير لعرض جميع المؤشرات المتاحة وأي معلومات مرتبطة بها. ضمن **مؤشرات Office**، حدد **تحديد الكل**، ثم حدد **حفظ**.
...
1. من صفحة نظرة عامة على إدارة المخاطر الداخلية، حدد علامة التبويب **النهُج** ثم حدد **+ إنشاء نهج**.  قم بتكوين كل من علامات تبويب النهج التالية.
    ...
    1. المؤشرات: لاحظ أنه يتم تحديد كل مؤشرات المكتب التي حددتها في المهمة السابقة.  قم بالتمرير خلال الصفحة لمشاهدة مؤشرات النُهُج الأخرى المتاحة والعناصر الأخرى التي يتم تحديدها تلقائيًا.   يتم تمكين اكتشاف التسلسل.  إذا تم اكتشاف سلسلة من الأنشطة، كما هو محدد، فهذا يشير إلى مخاطر أكبر.  مرر مؤشر الماوس فوق أيقونة المعلومات للحصول على معلومات مفصلة.  تتطلب هذه العناصر تحديد مؤشرات معينة وتشغيل الأجهزة.  للتبسيط، ولأنه ليس لدينا أجهزة على هذا المستأجر، قم بإلغاء **تحديد الكل**. 
...
1. في النهج التي قمت بإنشائه للتو، يمثل حقل "المستخدمون في النطاق" المستخدمين الذين يتم تعيين درجات مخاطرهم حاليًا بواسطة النهج.  يحدث تعيين درجات المخاطرة للمستخدمين عندما يتم تشغيل النهج وهذا هو السبب في أن القيمة تظهر 0.  يمكن للمسؤول تكوين النهج لبدء تعيين درجات المخاطر لمستخدمين محددين، استنادًا إلى النشاط الذي تم اكتشافه بواسطة النهُج التي حددتها، والذي يتجاوز متطلبات اكتشاف حدث بدء التشغيل أولاً.  للقيام بذلك، حدد الدائرة الفارغة بجوار اسم النهج لتحديد النهج، ثم حدد **بدء نشاط التسجيل للمستخدمين**، والذي يظهر أعلى جدول النهج.  قم بتعبئة كل حقل، ثم حدد **بدء نشاط التسجيل**.  قد يستغرق ظهور المستخدمين في علامة التبويب "المستخدمون" 24 ساعة. بعد ذلك الوقت، يمكنك تحديد المستخدمين من علامة التبويب هذه لمراجعة الأنشطة المكتشفة.  حدد **إغلاق** في أسفل الصفحة.
